...
def home(request):
    ...
    low_queryset = Risk_Table.objects.filter(classification='') & Risk_Table.objects.filter(Risk_Score__range=(0,25))
    medium_queryset = Risk_Table.objects.filter(classification='') & Risk_Table.objects.filter(Risk_Score__range=(26,50))
    high_queryset = Risk_Table.objects.filter(classification='') & Risk_Table.objects.filter(Risk_Score__range=(51,75))
    critical_queryset = Risk_Table.objects.filter(classification='') & Risk_Table.objects.filter(Risk_Score__range=(77,100))
